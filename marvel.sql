...
-- q2: SELECT name FROM people

--q3: UPDATE people SET name = 'Krusty The Clown' WHERE id = 13

--q4: SELECT * FROM people WHERE id = 1

--q5: DELETE FROM movies WHERE id = 9

--q6: INSERT INTO people (name) VALUES ('Bart Simpson')

--q7: DELETE FROM people WHERE id = 11

--q8: INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2018, '00:00');

--q9: UPDATE movies SET (title, year, show_time) = ('Iron Man 3', 2013, '23:55') WHERE id = 7;